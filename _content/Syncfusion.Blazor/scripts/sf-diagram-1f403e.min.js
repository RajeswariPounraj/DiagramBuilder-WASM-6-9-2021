...
window.sfBlazor.DiagramWasm = function () {
  ...
  var diagram = {
    ...
    updateInnerLayerSize: function updateInnerLayerSize(layerList, width, height, element, left, top, eventValue) {
    ...
    getTextOptions: function getTextOptions(content, size, style, maxWidth) {
      ...
      options.whiteSpace = this.whiteSpaceToString(style.whiteSpace, style.textWrapping);
      options.content = content;
      options.textWrapping = style.textWrapping;
      options.breakWord = this.wordBreakToString(style.textWrapping);
      options.textAlign = this.textAlignToString(style.textAlign);
    ...
    onAddWireEvents: function onAddWireEvents(element, component, interval) {
      var _this = this;
    ...
    getMouseEvents: function getMouseEvents(evt) {
      ...
      if (!this.isForeignObject(evt.target, true) && (evt.type == "mouseleave" || evt.type == "mousmove" || evt.type == "mousedown" || evt.type == "mouseup" || evt.type == "keydown")) {
        evt.preventDefault();
      }
